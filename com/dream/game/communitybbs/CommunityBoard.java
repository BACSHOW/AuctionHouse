...
import com.dream.game.communitybbs.Manager.MailBBSManager;
...
public class CommunityBoard
{
	...
	public void handleCommands(L2GameClient client, String command)
	{
		...
		if (Config.COMMUNITY_TYPE.equals("full"))
		{
			...
			else if (command.startsWith("_bbsgetfav-ORIG"))
			{
			...
			else if (command.startsWith(AuctionBBSManager.getInstance().BBS_COMMAND))
			{
